...
- https://validator.w3.org/nu/?doc=https://akashebaev-ux.github.io/mariaflowers/index.html
...
| --- | --- | --- | --- | --- |
| bag | [bag-total.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/templates/bag/bag-total.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-bag-total.png) | ⚠️ Notes (if applicable) |
| bag | [bag.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/templates/bag/bag.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-bag.png) | ⚠️ Notes (if applicable) |
| bag | [checkout-buttons.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/templates/bag/checkout-buttons.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-checkout-buttons.png) | ⚠️ Notes (if applicable) |
| bag | [product-image.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/templates/bag/product-image.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-product-image.png) | ⚠️ Notes (if applicable) |
| bag | [product-info.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/templates/bag/product-info.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-product-info.png) | ⚠️ Notes (if applicable) |
| bag | [quantity-form.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/templates/bag/quantity-form.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-bag-quantity-form.png) | ⚠️ Notes (if applicable) |
| checkout | [checkout.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/templates/checkout/checkout.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-checkout-checkout.png) | ⚠️ Notes (if applicable) |
| checkout | [checkout_success.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/templates/checkout/checkout_success.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-checkout-checkout_success.png) | ⚠️ Notes (if applicable) |
| checkout | [submit_review.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/templates/checkout/submit_review.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-checkout-submit_review.png) | ⚠️ Notes (if applicable) |
| home | [contact.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/home/templates/home/contact.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-home-contact.png) | ⚠️ Notes (if applicable) |
| home | [index.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/home/templates/home/index.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-home-index.png) | ⚠️ Notes (if applicable) |
| products | [add_product.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/templates/products/add_product.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-products-add_product.png) | ⚠️ Notes (if applicable) |
| products | [edit_product.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/templates/products/edit_product.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-products-edit_product.png) | ⚠️ Notes (if applicable) |
| products | [product_detail.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/templates/products/product_detail.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-products-product_detail.png) | ⚠️ Notes (if applicable) |
| products | [products.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/templates/products/products.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-products-products.png) | ⚠️ Notes (if applicable) |
| profiles | [profile.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/profiles/templates/profiles/profile.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-profiles-profile.png) | ⚠️ Notes (if applicable) |
| templates | [about.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/templates/about.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-about.png) | ⚠️ Notes (if applicable) |
| templates | [delivery_policy.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/templates/delivery_policy.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-delivery_policy.png) | ⚠️ Notes (if applicable) |
| templates | [404.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/templates/errors/404.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-404.png) | ⚠️ Notes (if applicable) |
| templates | [faq.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/templates/faq.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-faq.png) | ⚠️ Notes (if applicable) |
| templates | [privacy_policy.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/templates/privacy_policy.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-privacy_policy.png) | ⚠️ Notes (if applicable) |
| templates | [refund_policy.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/templates/refund_policy.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-refund_policy.png) | ⚠️ Notes (if applicable) |
| templates | [terms_conditions.html](https://github.com/akashebaev-ux/mariaflowers/blob/main/templates/terms_conditions.html) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/html-templates-terms_conditions.png) | ⚠️ Notes (if applicable) |
...
- https://jigsaw.w3.org/css-validator/validator?uri=https://mariaflowers-f9e87b4ebe6c.herokuapp.com
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| checkout | [checkout.css](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/static/checkout/css/checkout.css) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/css-checkout-checkout.png) | ⚠️ Notes (if applicable) |
| profiles | [profile.css](https://github.com/akashebaev-ux/mariaflowers/blob/main/profiles/static/profiles/css/profile.css) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/css-profiles-profile.png) | ⚠️ Notes (if applicable) |
| static | [base.css](https://github.com/akashebaev-ux/mariaflowers/blob/main/static/css/base.css) | ⚠️ Link (if applicable) | ![screenshot](documentation/validation/css-static-base.png) | ⚠️ Notes (if applicable) |
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| checkout | [stripe_elements.js](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/static/checkout/js/stripe_elements.js) |  | ![screenshot](documentation/validation/js-checkout-stripe_elements.png) | ⚠️ Notes (if applicable) |
| products | [greeting_card.js](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/static/products/greeting_card.js) |  | ![screenshot](documentation/validation/js-products-greeting_card.png) | ⚠️ Notes (if applicable) |
| products | [product_customisation.js](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/static/products/product_customisation.js) |  | ![screenshot](documentation/validation/js-products-product_customisation.png) | ⚠️ Notes (if applicable) |
| profiles | [countryfield.js](https://github.com/akashebaev-ux/mariaflowers/blob/main/profiles/static/profiles/js/countryfield.js) |  | ![screenshot](documentation/validation/js-profiles-countryfield.png) | ⚠️ Notes (if applicable) |
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| bag | [admin.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/bag/admin.py) | ![screenshot](documentation/validation/py-bag-admin.png) | ⚠️ Notes (if applicable) |
| bag | [contexts.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/contexts.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/bag/contexts.py) | ![screenshot](documentation/validation/py-bag-contexts.png) | ⚠️ Notes (if applicable) |
| bag | [models.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/bag/models.py) | ![screenshot](documentation/validation/py-bag-models.png) | ⚠️ Notes (if applicable) |
| bag | [bag_tools.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/templatetags/bag_tools.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/bag/templatetags/bag_tools.py) | ![screenshot](documentation/validation/py-bag-bag_tools.png) | ⚠️ Notes (if applicable) |
| bag | [tests.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/bag/tests.py) | ![screenshot](documentation/validation/py-bag-tests.png) | ⚠️ Notes (if applicable) |
| bag | [urls.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/bag/urls.py) | ![screenshot](documentation/validation/py-bag-urls.png) | ⚠️ Notes (if applicable) |
| bag | [views.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/bag/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/bag/views.py) | ![screenshot](documentation/validation/py-bag-views.png) | ⚠️ Notes (if applicable) |
| boutique_ado | [settings.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/boutique_ado/settings.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/boutique_ado/settings.py) | ![screenshot](documentation/validation/py-boutique_ado-settings.png) | ⚠️ Notes (if applicable) |
| boutique_ado | [urls.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/boutique_ado/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/boutique_ado/urls.py) | ![screenshot](documentation/validation/py-boutique_ado-urls.png) | ⚠️ Notes (if applicable) |
| boutique_ado | [views.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/boutique_ado/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/boutique_ado/views.py) | ![screenshot](documentation/validation/py-boutique_ado-views.png) | ⚠️ Notes (if applicable) |
| checkout | [admin.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/checkout/admin.py) | ![screenshot](documentation/validation/py-checkout-admin.png) | ⚠️ Notes (if applicable) |
| checkout | [forms.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/checkout/forms.py) | ![screenshot](documentation/validation/py-checkout-forms.png) | ⚠️ Notes (if applicable) |
| checkout | [models.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/checkout/models.py) | ![screenshot](documentation/validation/py-checkout-models.png) | ⚠️ Notes (if applicable) |
| checkout | [signals.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/signals.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/checkout/signals.py) | ![screenshot](documentation/validation/py-checkout-signals.png) | ⚠️ Notes (if applicable) |
| checkout | [tests.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/checkout/tests.py) | ![screenshot](documentation/validation/py-checkout-tests.png) | ⚠️ Notes (if applicable) |
| checkout | [urls.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/checkout/urls.py) | ![screenshot](documentation/validation/py-checkout-urls.png) | ⚠️ Notes (if applicable) |
| checkout | [views.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/checkout/views.py) | ![screenshot](documentation/validation/py-checkout-views.png) | ⚠️ Notes (if applicable) |
| checkout | [webhook_handler.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/webhook_handler.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/checkout/webhook_handler.py) | ![screenshot](documentation/validation/py-checkout-webhook_handler.png) | ⚠️ Notes (if applicable) |
| checkout | [webhooks.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/webhooks.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/checkout/webhooks.py) | ![screenshot](documentation/validation/py-checkout-webhooks.png) | ⚠️ Notes (if applicable) |
| checkout | [whatsapp.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/checkout/whatsapp.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/checkout/whatsapp.py) | ![screenshot](documentation/validation/py-checkout-whatsapp.png) | ⚠️ Notes (if applicable) |
|  | [custom_storages.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/custom_storages.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/custom_storages.py) | ![screenshot](documentation/validation/py--custom_storages.png) | ⚠️ Notes (if applicable) |
| home | [admin.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/home/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/home/admin.py) | ![screenshot](documentation/validation/py-home-admin.png) | ⚠️ Notes (if applicable) |
| home | [forms.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/home/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/home/forms.py) | ![screenshot](documentation/validation/py-home-forms.png) | ⚠️ Notes (if applicable) |
| home | [models.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/home/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/home/models.py) | ![screenshot](documentation/validation/py-home-models.png) | ⚠️ Notes (if applicable) |
| home | [tests.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/home/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/home/tests.py) | ![screenshot](documentation/validation/py-home-tests.png) | ⚠️ Notes (if applicable) |
| home | [urls.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/home/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/home/urls.py) | ![screenshot](documentation/validation/py-home-urls.png) | ⚠️ Notes (if applicable) |
| home | [views.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/home/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/home/views.py) | ![screenshot](documentation/validation/py-home-views.png) | ⚠️ Notes (if applicable) |
| home | [whatsapp.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/home/whatsapp.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/home/whatsapp.py) | ![screenshot](documentation/validation/py-home-whatsapp.png) | ⚠️ Notes (if applicable) |
|  | [manage.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/manage.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/manage.py) | ![screenshot](documentation/validation/py--manage.png) | ⚠️ Notes (if applicable) |
| products | [admin.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/products/admin.py) | ![screenshot](documentation/validation/py-products-admin.png) | ⚠️ Notes (if applicable) |
| products | [forms.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/products/forms.py) | ![screenshot](documentation/validation/py-products-forms.png) | ⚠️ Notes (if applicable) |
| products | [models.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/products/models.py) | ![screenshot](documentation/validation/py-products-models.png) | ⚠️ Notes (if applicable) |
| products | [tests.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/products/tests.py) | ![screenshot](documentation/validation/py-products-tests.png) | ⚠️ Notes (if applicable) |
| products | [urls.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/products/urls.py) | ![screenshot](documentation/validation/py-products-urls.png) | ⚠️ Notes (if applicable) |
| products | [views.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/products/views.py) | ![screenshot](documentation/validation/py-products-views.png) | ⚠️ Notes (if applicable) |
| products | [widgets.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/products/widgets.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/products/widgets.py) | ![screenshot](documentation/validation/py-products-widgets.png) | ⚠️ Notes (if applicable) |
| profiles | [admin.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/profiles/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/profiles/admin.py) | ![screenshot](documentation/validation/py-profiles-admin.png) | ⚠️ Notes (if applicable) |
| profiles | [forms.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/profiles/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/profiles/forms.py) | ![screenshot](documentation/validation/py-profiles-forms.png) | ⚠️ Notes (if applicable) |
| profiles | [models.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/profiles/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/profiles/models.py) | ![screenshot](documentation/validation/py-profiles-models.png) | ⚠️ Notes (if applicable) |
| profiles | [tests.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/profiles/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/profiles/tests.py) | ![screenshot](documentation/validation/py-profiles-tests.png) | ⚠️ Notes (if applicable) |
| profiles | [urls.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/profiles/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/profiles/urls.py) | ![screenshot](documentation/validation/py-profiles-urls.png) | ⚠️ Notes (if applicable) |
| profiles | [views.py](https://github.com/akashebaev-ux/mariaflowers/blob/main/profiles/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/akashebaev-ux/mariaflowers/main/profiles/views.py) | ![screenshot](documentation/validation/py-profiles-views.png) | ⚠️ Notes (if applicable) |
