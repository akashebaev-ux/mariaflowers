"""
Django settings for MariaFlowers project.
...
if os.path.isfile('env.py'):
    import env  # flake8 will throw an error here, but it is necessary to import env.py  # noqa
...
MIDDLEWARE = [
    ...
    "mariaflowers.middleware.RemoveWWWRedirectMiddleware",
...
ROOT_URLCONF = 'mariaflowers.urls'
...
WSGI_APPLICATION = 'mariaflowers.wsgi.application'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'www.mariaflowers.art@gmail.com'
else:
...
WHATSAPP_CONTACT_RECIPIENT = os.getenv(
    "WHATSAPP_CONTACT_RECIPIENT",
    "",
)
